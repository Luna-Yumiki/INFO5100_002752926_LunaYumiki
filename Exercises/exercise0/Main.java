...
class Employee {
    ...
    class Baby {
        ...
        public static class BabyToy {
            ...
            private String type;
            public BabyToy(String toyName, String type) {
            ...
            public void play() {
                System.out.println("BabyToy is called" + toyName + "his type is " + type);
            }
        ...
        public class MilkBottle {
            ...
            public void Hungry() {
                isEmpty = true;
                System.out.println(name + "Baby is hungry!");
            }

            public void Full() {
                isEmpty = false;
                System.out.println(name + "Baby is full");
            }
        }
    }
